...
fun TLMessageMediaDocument.getMediaInput() = when (document) {
    is TLDocument -> {
        ...
        val inputFileLocation = InputFileLocation(TLInputDocumentFileLocation(document.id, document.accessHash, document.fileReference, document.version), document.dcId)
